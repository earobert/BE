...
#===============================================#
# Model 4, in the format of Model 1 and 2. Gamma is constrained, but cancels out
# Here we assume no size and byssus cost relationship
