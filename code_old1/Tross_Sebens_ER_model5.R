...
# This is the main working model right now. 
#===============================================#
...
Autumn.est <- optim(fn=a.est.NLL1, par=c(food = 3, cost_induced_byssus = 0.01, sigma = 100), season = "Autumn", hessian = TRUE) # par are the starting values
