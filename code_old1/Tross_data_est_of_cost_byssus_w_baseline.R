...
#===============================================#
# Model 2, with gamma left unconstrained. 
...
mod.2 <- function(params, season) {
  food_scalar <- params[1] 
  cost_per_thread <- params[2]
  baseline_byssus_multiplier <- params[3]
  sigma <- params[4]
  season <- season
...
# For troubleshooting:
 # params <- c(food = 1, cost_induced_byssus = 0.01, cost_baseline_byssus = 0.08, sigma = 100)
 # season <- "Autumn"
...
Autumn.est <- optim(fn=a.est.NLL1, par=c(food = 1, cost_induced_byssus = 0.01, cost_baseline_byssus = 0.08, sigma = 100), season = "Autumn") # par are the starting values
Spring.est <- optim(fn=a.est.NLL1, par=c(food = 1, cost_induced_byssus = 0.01, cost_baseline_byssus = 0.08, sigma = 100), season = "Spring") # par are the starting values
